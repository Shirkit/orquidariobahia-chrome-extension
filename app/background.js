...
function onMessageExternal(message) {
  ...
  if (message.action === 'pay') {
    if (!message.amount || !message.paymentMethod) {
      ...
      setTimeout(function() {connection.postMessage(JSON.parse('{"response":"pay_ok","message":"Transação autorizada","data":{"transactionCode":"1A8D27707D7D4428957FD4DC6B62020F","date":"2019-07-06","time":"15:34:38","hostNsu":"70600011698","cardBrand":"MASTERCARD","bin":"516292","holder":"8357","userReference":"UserRef","terminalSerialNumber":"1260091723"}}'));}, 100);
